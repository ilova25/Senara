...
@section('content')
  ...
  <div class="image-banner">
    <img src="{{ asset('images/lobby.png') }}" alt="Lobby">
  </div>
  ...
  <section class="section">
    ...
    <div class="facilities">
      <div class="facility-card">
        <img src="{{ asset('images/pool.png') }}" alt="Public Pool">
        <h4>Public Pool</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
      </div>
      <div class="facility-card">
        <img src="{{ asset('images/gym.png') }}" alt="Gym">
        <h4>Gym</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
      </div>
      <div class="facility-card">
        <img src="{{ asset('images/laundry.png') }}" alt="Laundry">
        <h4>Laundry</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
      </div>
      <div class="facility-card">
        <img src="{{ asset('images/spa.png') }}" alt="SPA">
        <h4>SPA</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
      </div>
    </div>
  ...
  <section class="section">
    ...
    <div class="promotions">
      <img src="{{ asset('images/promo1.png') }}" alt="Flash Sale" class="card" style="width: 540px;">
      <img src="{{ asset('images/promo2.png') }}" alt="Long Stay" class="card" style="width: 540px;">
    </div>
  </section>
