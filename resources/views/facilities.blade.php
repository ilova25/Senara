...
@section('content')
    ...
    * {
    ...
    .facility-card:nth-child(1) { border-top: 4px solid #543310; }
    .facility-card:nth-child(2) { border-top: 4px solid #74512D; }
    .facility-card:nth-child(3) { border-top: 4px solid #AF8F6F; }
    .facility-card:nth-child(4) { border-top: 4px solid #543310; }
    .facility-card:nth-child(5) { border-top: 4px solid #74512D; }
    .facility-card:nth-child(6) { border-top: 4px solid #AF8F6F; }
...
<!-- Bagian section-intro sudah dihapus -->
